## Theory 1A: Definition of Agentic AI
...
- A system is closer to agentic when it can:
  - choose actions conditionally,
  - recover from errors,
  - and continue execution until a completion criterion is met.
...
```md
![Agentic AI architecture draft](./images/agentic-ai-architecture.png)
```
...
The key shift is from "good answer quality" to "reliable task completion quality."

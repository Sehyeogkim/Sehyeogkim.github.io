...
Source: [https://jeffdissel.tistory.com/68](https://jeffdissel.tistory.com/68)

방금까지 배운 열역학 개념들을 이제 써먹어 보자.
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-001.png)
...
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-002.png)
First 1 law of T.D에서 시간에 따른 변화량으로 살펴보자.
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-003.png)
위 식을 Mass flow rate 로 나누어 주고, 밑의 에너지 식을 대입 + System -> Control Volume으로 전환
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-004.png)
...
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-005.png)
이 식이 가장 핵심적인
에너지 방정식
입니다.
Steady - State
의 경우,
(시간에 따라 모든 값 일정)
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-006.png)
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-007.png)
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-006.png)
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-007.png)
Transient - State
의 경우, 위의 시간에 따른 변화율을 모두 적분해주면,
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-008.png)
![[Thermodynamics] Ch 4. Energy Analysis for a C.V](./images/img-009.png)

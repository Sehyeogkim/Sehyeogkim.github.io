...
Source: [https://jeffdissel.tistory.com/111](https://jeffdissel.tistory.com/111)
...
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-001.png)
각속도 = u_θ /r
2. Circulation
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-002.png)
정의를 쉽게 풀어서 생각해보자.
어떠한 폐곡선의 curve C가 존재하고,
폐곡선에서 임의의 미세한 유체 입자를 선택해보자.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-003.jpg)
그렇다면, 위 사진처럼
circulation은 결국 폐곡선을 따라서,
곡선의 유체들이 얼마나 회전하는지를 나타낸다.
Stoke's Theorem을 이용해서,
선적분 -> 면적분으로 전환해주자.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-004.png)
결국 정리해보면,
Vorticity
...
Vortex tube라고 부른다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-005.png)
여기서, Vortex tube 전체 volume의 divergence of w 를 체적분 한후,
Gauss's Theorem으로 체적분을 면적분으로 바꾸어 주자.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-006.png)
여기서 curved side는 바로, vortex tube의 옆면을 의미하는데,
옆면의 법선벡터 n과 w는 항상 수직하므로, 내적 = 0 이다.
따라서, lower upper end 항만 남게 된다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-007.jpg)
...
유동에 대해서 살펴보자.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-008.png)
위에서
살펴본 profile은 다음과 같을 것이고,
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-009.png)
실린더 coordinate로 살펴보면,
ur = 0, u
θ= rw0(w0: angular velocity)임을 알 수 있다.
따라서, strain rate tensor 는 전부 0이므로
우리는 비점성 유동이라는 것을 알 수 있다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-010.jpg)
여기에 incompressible, steady 가정만 더 해주면
우리는 모멘텀 방정식을 Euler's equation으로 사용 할 수 있다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-011.jpg)
위에서 구한 속도장을 대입해주면,
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-012.png)
위와 같이 정리가 되고, 이제 적분을 통한 1번 식을 2번식에 대입해주자.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-013.png)
...
(즉 베르누의 성립 x)
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-014.png)
____________
...
deform은 하였지만,
irrotational 한 유동이다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-015.png)
아주 특이한 것은 r= 0 에서는 w -> infinity로 굉장히 회전력이 강하다;;
아무튼 이런 특이한 유동을 분석해보면,
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-016.png)
먼저, circulation을 다음과 같이 나타낼 수 있고,
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-017.png)
...
따라서, 비점성 유동해석이 가능하다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-018.png)
비점성유동이라는 것을 확인하였고,
여기에 Incompressible, steady-state assumption만 추가해주면
아까 위에서 증명한 solid rotation flow와 동일하게
오일러 방정식이 적용가능하다.
똑같이 적용해주면 다음 1,2식이 도출된다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-019.png)
1,2식이 나오게 되고 위 두식을 연립하면
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-020.png)
압력, z,r의 식이 도출된다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-021.png)
irrotational vortex 등압선.
위식의 P infi - const로 바꾸고, circulation을 다시 u theat로 바꾸면
다음과 같이 베르누의 방정식이 도출된다.
![ch3 Vorticity dynamics_part1_circulation & vorticity](./images/img-022.png)

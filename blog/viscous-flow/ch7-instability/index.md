...
Source: [https://jeffdissel.tistory.com/m/135](https://jeffdissel.tistory.com/m/135)
...
불안정성
이다.
![Ch7 Instability](./images/img-001.png)
...
다음의 두가지 가정을 해주자.
![Ch7 Instability](./images/img-002.png)
이제 perturbation의 식을 세워기 전에,
기본적인 상황을 가정해보자.
기본적으로 x방향으로 유체가 흐르고 있다고 가정해보자.
그리고 Basic state의 속도장은 z에 따라 변한다고 가정하자.
![Ch7 Instability](./images/img-003.png)
![Ch7 Instability](./images/img-004.png)
![Ch7 Instability](./images/img-003.png)
![Ch7 Instability](./images/img-004.png)
Basic flow.
...
![Ch7 Instability](./images/img-008.png)
...
![Ch7 Instability](./images/img-009.png)
...
- Kelvin-Helmholtz Instability-
에 대해서 알아보자.
![Ch7 Instability](./images/img-010.png)
...
![Ch7 Instability](./images/img-011.png)
...
definition of velocity potential
대입후 정리해주면,
![Ch7 Instability](./images/img-014.png)
여기서, linearization,
그리고 차수가 높은 항을 제거해주면,
![Ch7 Instability](./images/img-015.png)
BC (b) 로 유도한 식.(추후에 쓰임)
한편, unsteady bernoulli eq으로
interface 근처 velocity potential을
다음과 같이 식을 세울 수 있다.
![Ch7 Instability](./images/img-016.png)
여기서 BC (c)에 따라서 P1 = P2이므로,
![Ch7 Instability](./images/img-017.png)
한편, P = P_undistub(interace에서 먼 곳) 임을 이용하기 위해서,
undistibuted state의 압력을 각각 식 3에서 도출한다.
![Ch7 Instability](./images/img-018.png)
여기서, -1 * 3식 = -1 4식 으로 전개후 소거해주면
![Ch7 Instability](./images/img-019.png)
이에 velocity potential 정의를 대입해주자.
![Ch7 Instability](./images/img-020.png)
고차항을 제거해주자, 그리고 interface에서를 분석하기 위해 f = 0 -> z =
ζ
.
![Ch7 Instability](./images/img-021.png)
추후에 쓰일.5번식.
...
다음과 같이 정의가능하다.
![Ch7 Instability](./images/img-022.png)
위에 정의한 것을
...
![Ch7 Instability](./images/img-023.png)
여기에 이제 BC (a)를 대입해주자
![Ch7 Instability](./images/img-024.png)
bc (a) 적용.
이렇게 구한 상수항을 6번에 대입해주자.
![Ch7 Instability](./images/img-025.png)
자 우리는 velocity potential of perturbation을
지금, method of normal modes로
파동의 함수 형태(7번식)으로 정의하였다.
![Ch7 Instability](./images/img-026.png)
이제 지금까지 BC으로 위 두식들에
대입해주자.
먼저 2번식에 대입
![Ch7 Instability](./images/img-027.png)
![Ch7 Instability](./images/img-028.png)
이제 5번식에 대입해주자.
![Ch7 Instability](./images/img-029.png)
이후 상수항을 제거해 주기위해 8번식을 9번식에 대입해주자.
![Ch7 Instability](./images/img-030.png)
c에 관한 2차 방정식이므로, 정리해주고 근의 공식을 사용하자.
![Ch7 Instability](./images/img-031.png)
정리를 위해 빨간색 항을 전개해주면,
다음과 같이 c를 정리할 수 있다.
![Ch7 Instability](./images/img-032.png)
...
![Ch7 Instability](./images/img-033.png)
이는 지금 밑의 상황에서,
두 유체의 속도차이가 크고,
밀도 차이가 작고
k가 클때
unstable가능성이 큼을 알 수 있다.
![Ch7 Instability](./images/img-034.png)
_______________________________________
이번에는 두 유체가 모두 정지해있다고 가정해보자.
이때, c는 다음과 같이 정리된다.
![Ch7 Instability](./images/img-035.png)
여기서 만약에 2(위)의 유체 밀도가 더 크다면?
instable함을 알 수 있다.
![Ch7 Instability](./images/img-036.png)

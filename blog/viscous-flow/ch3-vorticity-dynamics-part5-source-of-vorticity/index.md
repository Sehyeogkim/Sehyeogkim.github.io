...
Source: [https://jeffdissel.tistory.com/m/117](https://jeffdissel.tistory.com/m/117)
...
탐구해보자.
벽면에서의 모든 velocity = 0
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-001.png)
0 notation - values on the wall.
그리고, 아래의 그림같은 상황에서,
x0과 평행한 속도 성분 - u,w
z0과 평행한 속도 성분 - u,w
의 변화는 없다고 가정하자.
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-002.png)
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-003.png)
incompressible flow의 가정이후 연속방정식
vorticty의 정의를 적용하면,
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-004.png)
이제 여기서,
위 그림에 나오는
...
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-005.png)
...
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-003.png)
n = (0,1,0)
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-006.png)
x방향 viscous force 만 남게 된다.
이를 vorticity로 표현해보면.
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-007.png)
즉, 여기서 하고 싶은 말은,
...
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-008.png)
위의 예시 그대로, n = (0,1,0)일 때,
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-009.png)
이제, 벽면에서 vorticity flux를 계산하기 위해서
Navier's Stokes 방정식을 세워보자.
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-010.png)
먼저, incompressible flow의 경우
연속방정식을 통해서, Laplace(u)를 다음과 같이 바꿀수 있고,
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-011.png)
+ 벽면에서 no-slip condition으로 u = (0,0,0)
+중력을 무시해주면
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-012.png)
여기서
x,z component
를 전개하면 다음과 같이 유도된다.
...
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-013.png)
위 두 식이 의미하는 것은,
...
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-014.png)
실제 예시를 통해서 확인해보자
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-015.png)
...
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-016.png)
...
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-017.png)
벽면이 회전없이 그저 오른쪽으로 U(t)로 움직이는 경우
다음과 같이 식 정리가 가능하다.
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-018.png)
똑같이, 벽면 위의 경우 u = (0,0,0)
x,z,성분의 식을 정리하면
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-019.png)
위식을 적용시킬 예시로
Airfoil 의 starting vortex를 살펴보자.
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-020.png)
일단, upper, lower surface에서 wz는 생성되지 않음을
밑의 식을 통해서 증명할 수 있다.
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-021.png)
...
![Ch3 Vorticity dynamics_part5_ source of vorticity](./images/img-022.png)

...
Source: [https://jeffdissel.tistory.com/m/146](https://jeffdissel.tistory.com/m/146)
...
![Diffusion Model](./images/img-001.png)
VAE vs GAN vs Diffusion Model
DIffusion model process에 대해서 자세하게 들어가보자.
(다소 복잡함.)
![Diffusion Model](./images/img-002.webp)
...
![Diffusion Model](./images/img-003.png)
여기서 정확히 말하면, 단계별로.
'Guassian Noise'
를 더해준다.
![Diffusion Model](./images/img-004.png)
gaussian noise adding process.
Guassian Noise(e) 란
N(0, β_t * I)의 확률분포를 따르는 값 중에서
하나 random 한 값이다.
![Diffusion Model](./images/img-005.png)
...
을 통해 다음과 같음을 알 수 있다.
![Diffusion Model](./images/img-006.png)
이제 이 스탭을 쭉 진행해주자.
![Diffusion Model](./images/img-007.png)
각 확률이 독립시행이므로, x_0(처음사진)에서 최종 노이즈가 될 확률은 다음과 같다.
![Diffusion Model](./images/img-008.png)
![Diffusion Model](./images/img-009.png)
여기서 alpha는 다음과 같이 정의됨을 알 수 있다.
![Diffusion Model](./images/img-010.png)
...
(동일한 확률분포의 노이즈)
![Diffusion Model](./images/img-011.png)
(조금 말이 어렵지만 한번 들어가보자)
...
![Diffusion Model](./images/img-012.png)
이를 다르게 표현하면, 결국
제거하는 노이즈가, 아까 더하였던 노이즈와 최대한 비슷해야한다는 것이다.
![Diffusion Model](./images/img-013.png)
다시 종합해서 말하면,

...
Source: [https://jeffdissel.tistory.com/m/95](https://jeffdissel.tistory.com/m/95)
...
Deep Learning
정확히 말하면, 딥러닝은
![Ch1. Optimization for Deep Learning](./images/img-001.png)
이렇게, 최소의 해(min)을
찾는 것을
가장 잘한다.
위의 예시를 보면,
...
![Ch1. Optimization for Deep Learning](./images/img-002.png)
아주 간단하다,
x백터의, 그레이디언트 백터를 정의하고,
![Ch1. Optimization for Deep Learning](./images/img-003.png)
연속, 미분가능한 f에서
최적의 point는
기울기 = 0 인 지점일 것이다.
(unconstrained op 는 x에 제약 조건이 없는 것이다)
(e.g) x>=0 조건이 있으면, constrained Op
![Ch1. Optimization for Deep Learning](./images/img-004.png)
그렇다면, x0에서 시작하고,
기울기에 alpha(step size)를 곱한 값만큼
x를 움직이는 것이다.
이 과정을 f'(x) = 0인 순간까지 진행하여
최적의 x*를 찾아내는 것이다
![Ch1. Optimization for Deep Learning](./images/img-005.png)
![Ch1. Optimization for Deep Learning](./images/img-006.png)
...
밑의 그림의 과정을 거친다.
![Ch1. Optimization for Deep Learning](./images/img-007.png)
...
![Ch1. Optimization for Deep Learning](./images/img-008.png)
여기서, 하지만 한가지 짚고 넘어가야할 부분,
Gradient decent방법이
Convex인 경우는
local min = global min이지만,
![Ch1. Optimization for Deep Learning](./images/img-009.png)
Non-convex같은 경우는

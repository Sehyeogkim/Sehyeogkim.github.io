...
sidebar:
  nav: "docs"
source_url: "https://jeffdissel.tistory.com/228"
source_id: "228"
date: "2025-09-09T10:06:44+09:00"
category: "Computational-Linear-Algebra"
---

Source: [https://jeffdissel.tistory.com/228](https://jeffdissel.tistory.com/228)
...
![5. Singular Value Decomposition(SVD) - part1](./images/img-001.png)
그리고 Similiarity Transformation이 된
Matrix B와 기존의 A의 관계를 Simliar하다
고 정의한다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-002.png)
다르게 표현하면 다음과 같이 표현이 가능하고,
X를 Transforming Matrix
라고 정의한다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-003.png)
중요한점은!!!!
A와 B는 같은 EigenValue를 가진다는 것(Ch4에서 증명완료)
여기서 한발짝 더 나아가서, X = Q (unitary Matirx)라고 했을때,
Q-1 = Q* 임을 이용하면, 다음과 같이 분해 가능하다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-004.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-005.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-004.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-005.png)
위 과정의 핵심은
Francis' Algorithm
...
오늘 다룰 분해 방법인 SVD
가 더 많이 쓰인다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-006.png)
m x n Matrix A (rank: r < m)
![5. Singular Value Decomposition(SVD) - part1](./images/img-007.png)
먼저 range(A)를 다음과 같이 정의할 수 있다.
A의 independent 기저벡터들로 이루어진 space.
![5. Singular Value Decomposition(SVD) - part1](./images/img-008.png)
여기서 A를
Singular Value Decomposition
한 최종 form은 다음과 같다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-009.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-010.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-009.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-010.png)
...
![5. Singular Value Decomposition(SVD) - part1](./images/img-011.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-012.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-011.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-012.png)
다시 dimension을 살펴보면,
A : m x n
...
![5. Singular Value Decomposition(SVD) - part1](./images/img-013.png)
A가 n x n 행렬일때, sigma_j가 전부 다르다면 singular vector들도
유일히 결정된다는 사실.
#Application - Diagonal matrix Eq.
![5. Singular Value Decomposition(SVD) - part1](./images/img-014.png)
...
![5. Singular Value Decomposition(SVD) - part1](./images/img-015.png)
...
먼저 SVD 된 A를 A*A에 대입.
![5. Singular Value Decomposition(SVD) - part1](./images/img-016.png)
여기서 재미있는 사실은
A: m x n Matrix -> A*A : n x n Matrix
따라서, EVD가 가능해졌다.
V는 Orthogonal Matrix이므로 ( V* = V-1)
따라서, Eigenvalue of (A*A) = σ^2
![5. Singular Value Decomposition(SVD) - part1](./images/img-017.png)
#Application - Spectral Norm.
우리가 SVD를 이용하면, Matrix A의 norm을 쉽게 구할 수 있다.
먼저 Matrix norm의 종류는 여러가지가 있고, 그중에서 2가지를 살펴보자.
![5. Singular Value Decomposition(SVD) - part1](./images/img-018.png)
Spectral Norm
![5. Singular Value Decomposition(SVD) - part1](./images/img-019.png)
Frobenius norm
![5. Singular Value Decomposition(SVD) - part1](./images/img-020.png)
이렇게 singular Value를 이용해서 쉽게 구할 수 있다. 증명해보자.
1. Spectral Norm
![5. Singular Value Decomposition(SVD) - part1](./images/img-018.png)
Spectral Norm
편의상 ||x|| = 1인 x Matrix를 다음과 같이 정의하자.
![5. Singular Value Decomposition(SVD) - part1](./images/img-021.png)
V: Singular right Matrix. (uniatry Matrix)
![5. Singular Value Decomposition(SVD) - part1](./images/img-022.png)
SVD를 이용하면 간단하게 증명가능하다 ( ||y|| = 1 이용)
2. Frobenius Norm
![5. Singular Value Decomposition(SVD) - part1](./images/img-019.png)
Frobenius norm
SVD 를 이용하면, A*A는 다음과 같다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-023.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-024.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-025.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-024.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-025.png)
trace 성질 이용.
따라서, 최종적으로 norm은 다음과 같다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-026.png)
#Application - Spectral condition Number.
![5. Singular Value Decomposition(SVD) - part1](./images/img-027.png)
Definition of Condition Number
(Condition Number는 수치적안정성을 측정하는 기준치로 사용됨, 이후에 설명)
위 정의에 SVD 분해를 활용하여 방금전에 Norm을 증명하였다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-028.png)
역행렬의 경우,
![5. Singular Value Decomposition(SVD) - part1](./images/img-029.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-030.png)
Inverse of diagonl Matrix
norm 의 정의에 그대로 대입해주면,
![5. Singular Value Decomposition(SVD) - part1](./images/img-031.png)
따라서, 최종적으로 condition Number는 다음과 같다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-032.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-033.png)
#Application - Rank determination
SVD of A (m x n Matrix, rank r)
![5. Singular Value Decomposition(SVD) - part1](./images/img-034.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-035.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-034.png)
![5. Singular Value Decomposition(SVD) - part1](./images/img-035.png)
즉 여기서,
...
![5. Singular Value Decomposition(SVD) - part1](./images/img-036.png)
당연히, Ak ! = A 일 것이다. 그 오차를 norm 으로 표현하면 다음과 같다.
![5. Singular Value Decomposition(SVD) - part1](./images/img-037.png)
하지만, 오차가 그렇게 크지 않는 k를 찾을 수 있을까???
![5. Singular Value Decomposition(SVD) - part1](./images/img-038.png)
...
(계산속도 빨라짐, 정보저장공간 확보)
![5. Singular Value Decomposition(SVD) - part1](./images/img-039.png)

...
sidebar:
  nav: "docs"
source_url: "https://jeffdissel.tistory.com/m/227"
source_id: "227"
date: "2025-09-08T23:27:20+09:00"
category: "Computational-Linear-Algebra"
---

Source: [https://jeffdissel.tistory.com/m/227](https://jeffdissel.tistory.com/m/227)
...
(지난포스터 내용)
![4. Eigen Value Problem - part2](./images/img-001.png)
...
![4. Eigen Value Problem - part2](./images/img-002.png)
...
![4. Eigen Value Problem - part2](./images/img-003.png)
지난시간에 다루었던, similiart transformation에서 파생된 분해들은...
![4. Eigen Value Problem - part2](./images/img-004.png)
(digonal Matrix: Sigma)
조건: A는 non singular Matrix
![4. Eigen Value Problem - part2](./images/img-005.png)
(digonal Matrix: Sigma)
조건:
A
...
![4. Eigen Value Problem - part2](./images/img-006.png)
A -> T로 수렴시키는 방법을 사용한다.
![4. Eigen Value Problem - part2](./images/img-007.png)
자세하게는, 두과정을 통해 진행이 된다.
1. A -> H
2. H -> T
![4. Eigen Value Problem - part2](./images/img-008.png)
============================
그런데 여기서 잠깐.
...
![4. Eigen Value Problem - part2](./images/img-009.png)
근데 왜 바꿔???
...
![4. Eigen Value Problem - part2](./images/img-010.png)
...
![4. Eigen Value Problem - part2](./images/img-011.png)
![4. Eigen Value Problem - part2](./images/img-012.png)
![4. Eigen Value Problem - part2](./images/img-011.png)
![4. Eigen Value Problem - part2](./images/img-012.png)
dimension: (n -1) x 1
그리고 Q_hat을 확장시켜 n x n 크기의 Q1 Matrix를 정의한다.
![4. Eigen Value Problem - part2](./images/img-013.png)
![4. Eigen Value Problem - part2](./images/img-014.png)
![4. Eigen Value Problem - part2](./images/img-013.png)
![4. Eigen Value Problem - part2](./images/img-014.png)
아주 특이하게도 위의 성질을 띈다.
이제 이를 A1과 곱한 행렬을 A(1/2)라고 편의상 정의하자.
![4. Eigen Value Problem - part2](./images/img-015.png)
(1,1) (2,1)를 제외하고 1 행의 원소는 0.
이제 우리는 Similiarity Transformation을 해주기 위해서. Q1* = Q1을 뒤에 추가로 곱해준다.
![4. Eigen Value Problem - part2](./images/img-016.png)
![4. Eigen Value Problem - part2](./images/img-017.png)
![4. Eigen Value Problem - part2](./images/img-016.png)
![4. Eigen Value Problem - part2](./images/img-017.png)
...
![4. Eigen Value Problem - part2](./images/img-018.png)
이후 A1(1st iteration result)의 앞에 먼저곱해주면.
(Q hat 2 b2는 사실상 e1방향만 살아남고 나머지는 0으로 회전된 벡터이다)
![4. Eigen Value Problem - part2](./images/img-019.png)
Similiarity Transformation을 진행해야, eigenvalue가 그대로 보존이 되기때문에,
강제로 뒤에 Q2-1 = Q2 를 곱해주어 2nd iteration을 마무리하자.
![4. Eigen Value Problem - part2](./images/img-020.png)
위 과정을 계속해서 반복하면,
![4. Eigen Value Problem - part2](./images/img-021.png)
Q는 계속해서 누적되어 쌓이고,
![4. Eigen Value Problem - part2](./images/img-022.png)
최종적으로 Upper Hessenberg Matirx B를 A로부터 도출 할 수 있다.
![4. Eigen Value Problem - part2](./images/img-023.png)
사실상 Householder 와 거의 비슷하고,
Pseudo code는 다음과 같다.
![4. Eigen Value Problem - part2](./images/img-024.png)
그리고 총 연산수는 다음과 같다.
![4. Eigen Value Problem - part2](./images/img-025.png)
==============================
여기서 만약에 A = A* (Conjugate of A)인
Hermitan Matrix라면?
연산수는 당연히 절반으로 줄어들고,
대칭으로 0 이 계속해서 되는 것을 알 수 있다.
![4. Eigen Value Problem - part2](./images/img-026.png)
==============================
...
를 먼저 선행하고, 이후에
![4. Eigen Value Problem - part2](./images/img-027.png)
...
![4. Eigen Value Problem - part2](./images/img-028.png)
Shifted A Matrix.
위 결과 shifted A의 1st column은 다음과 같다.
![4. Eigen Value Problem - part2](./images/img-029.png)
여기서 위 벡터를 Reflector를 이용하여,
똑같이 전부 0으로 변환해주자.
![4. Eigen Value Problem - part2](./images/img-030.png)
그리고 eigenvalue보존을 위한 similiarty Transformation을 위해서,
뒤에 Q0를 다시 곱해주어야한다.
![4. Eigen Value Problem - part2](./images/img-031.png)
여기서 재밌는 사실은, 원래계획과 다르게 Q0를 뒤에 곱해주면,
이렇게 0으로 1행의 off diagonal term이 전부 바뀌는게 아니라
새로운 non zero term (Bulge)가 생성이 된다.
![4. Eigen Value Problem - part2](./images/img-032.png)
+: Bulge
bulge를 일단 무시하고,
그다음 2행의 off diagonal term을 0로 만들어 주는
Reflector Q23를 제작한 후에, 위 Matrix에 곱해주면,
![4. Eigen Value Problem - part2](./images/img-033.png)
신기하게도, Bulge가 이동한다.
![4. Eigen Value Problem - part2](./images/img-034.png)
...
![4. Eigen Value Problem - part2](./images/img-035.png)
2만큼 shift했다고 가정하자 (mu = 2)
![4. Eigen Value Problem - part2](./images/img-036.png)
첫 reflector는 1열 벡터 x를 e1방향을 제외하고 0으로 만드는 것.
![4. Eigen Value Problem - part2](./images/img-037.png)
Reflector를 만드는 방법은 householder algorithm에서와 동일하다.
![4. Eigen Value Problem - part2](./images/img-038.png)
Q0를 이용하여 H를 변형시키면 다음과 같이 bulge가 생성된다.
![4. Eigen Value Problem - part2](./images/img-039.png)
이제 기존에서와 같이 2행의 offdiagonal term을 0으로 만들
reflector를 다음과 같이 설정하고, 똑같이 곱해주자.
![4. Eigen Value Problem - part2](./images/img-040.png)
Q1 = G1으로 양옆에 곱해주면,
다음과같이 1행은 다시 bulge가 사라졌고,
오히려 2행에 bulge가 새롭게 생긴 것을 알 수 있다.
![4. Eigen Value Problem - part2](./images/img-041.png)

---
title: "2. QR Factorization - part3 (Given QR method)"
layout: single
author_profile: false
sidebar:
  nav: "docs"
source_url: "https://jeffdissel.tistory.com/222"
source_id: "222"
date: "2025-09-05T10:45:01+09:00"
category: "Computational-Linear-Algebra"
---

Source: [https://jeffdissel.tistory.com/222](https://jeffdissel.tistory.com/222)

우리의 목표는????
(Ax = b) Matrix linear equation의 해 x 를 구하는것.
![2. QR Factorization - part3 (Given QR method)](./images/img-001.png)
그 중 한가지 방법인 QR factorization은
A = QR 로 분해하여, 다음과같이 x를 쉽게 구할 수 있게 해준다.
![2. QR Factorization - part3 (Given QR method)](./images/img-002.png)
...
![2. QR Factorization - part3 (Given QR method)](./images/img-003.png)
어떤 한개의 벡터가 있다고 가정하자.
우리는 이 벡터를 회전하여 e1성분만 남기는게 목표.
Rotator를 다음과 같이 정의해주자.
![2. QR Factorization - part3 (Given QR method)](./images/img-004.png)
![2. QR Factorization - part3 (Given QR method)](./images/img-005.png)
Rotator를 기존벡터에 곱하게 되면, 다음과 같이
e1성분만 남는 것을 알 수 가 있다.
![2. QR Factorization - part3 (Given QR method)](./images/img-006.png)
자 이제 우리는 Rotator를 다음과 같이 제작하면,
특정 부분만 회전 시킬 수 있게 된다.
![2. QR Factorization - part3 (Given QR method)](./images/img-007.png)
위 원리를 가지고 Give QR Factorization Algorithm을
Pseudo code로 작성하면 다음과 같다.
![2. QR Factorization - part3 (Given QR method)](./images/img-008.png)
쉽게 말해서, A (m x n ) 행렬에서
첫번째 column은 row m부터 2번째 까지 전부 rotator를 활용하여 0 로 만들어준다.
![2. QR Factorization - part3 (Given QR method)](./images/img-009.png)
3번째 column같은 경우는
row m 부터, 4까지 0으로 rotator를 활용하여 만들어준다.
![2. QR Factorization - part3 (Given QR method)](./images/img-010.png)
...
if 문 알고리즘이 가능하기 때문)
![2. QR Factorization - part3 (Given QR method)](./images/img-011.png)

...
sidebar:
  nav: "docs"
source_url: "https://jeffdissel.tistory.com/242"
source_id: "242"
date: "2025-09-28T14:34:15+09:00"
category: "Computational-Linear-Algebra"
---

Source: [https://jeffdissel.tistory.com/242](https://jeffdissel.tistory.com/242)

![Ch8 Classical Iterative Method - part1](./images/img-001.png)
위 문제를 풀기위해 direct method만 지금까지 다루었지만,
사실 연산량 측면에서는 Iterative Method가 더 이득이다.
(Large sparse Matrix인 경우 특히 더)
![Ch8 Classical Iterative Method - part1](./images/img-002.png)
...
수렴한 해
라고 하자."
![Ch8 Classical Iterative Method - part1](./images/img-003.png)
위 틀안에서
Iterative Method
는 다음 두가지로 나뉘고, (고전적인 방법과 현대적인 방법)
![Ch8 Classical Iterative Method - part1](./images/img-004.png)
이번 시간(part1)에서는 Classical iterative Methods를 살펴보자.
iterative Method의 자세한 흐름은 다음과 같다.
1. Set Initial solution
![Ch8 Classical Iterative Method - part1](./images/img-005.png)
2. Update the solution(we'll learn how to update them)
![Ch8 Classical Iterative Method - part1](./images/img-006.png)
3. Stop the iteration when the soltuion converges
![Ch8 Classical Iterative Method - part1](./images/img-007.png)
해를 업데이트 하는 방식을 지금부터 살펴보자.
1. Jacobi Method
![Ch8 Classical Iterative Method - part1](./images/img-001.png)
우리가 풀고자하는 위 문제에서 i번째 b벡터 요소는 다음과 같이 표현된다.
![Ch8 Classical Iterative Method - part1](./images/img-008.png)
여기서 i = j 인 x요소만 남기고 전부 우항으로 넘겨주면,
![Ch8 Classical Iterative Method - part1](./images/img-009.png)
위 식을 가지고 우리는 x를 업데이트 할 것이다.
즉, xi를 업데이트 할때 우리는 주변 다른 index i != j 인 x를 가지고 업데이트 하는 것.
![Ch8 Classical Iterative Method - part1](./images/img-010.png)
x(k) -> k 번째 iteration 해 , x(k+1) -> k+1 번째 iteration 해.
즉, 해를 아래와 같이 계속 순차적으로 업데이트 하는 것.
![Ch8 Classical Iterative Method - part1](./images/img-011.png)
...
![Ch8 Classical Iterative Method - part1](./images/img-012.png)
Gauss - seidal method는 xi (k) -> xi (k+1)을 할때, 업데이트된 값들이 있으면
업데이트된 값들을 사용한다는 것이다.
![Ch8 Classical Iterative Method - part1](./images/img-013.png)
...
![Ch8 Classical Iterative Method - part1](./images/img-014.png)
(쉽게 말해 이전해를 반영)
놀라운 사실은 위 3가지 방식을 일반화할 수 있다.
여기서 Ax = b를 다음과 같이 component base로 표현해주자.
![Ch8 Classical Iterative Method - part1](./images/img-015.png)
Splitting Method(그냥 A를 두개의 Matrix로 분리, 단 M은 nonsingular Matrix)
![Ch8 Classical Iterative Method - part1](./images/img-016.png)
위 분리된 A를 Ax = b식에 대입해주면,
![Ch8 Classical Iterative Method - part1](./images/img-017.png)
위 식을 그대로 iterative method에 적용해주자.
![Ch8 Classical Iterative Method - part1](./images/img-018.png)
우리는 M을 non singular Matrix로 정의했기 때문에, M은 역행렬이 존재하므로
![Ch8 Classical Iterative Method - part1](./images/img-019.png)
따라서, 다음과 같이 B = M-1N으로 정리 가능하다.
![Ch8 Classical Iterative Method - part1](./images/img-020.png)
여기서 위 iterative method의 수렴성을 판단하기 위해 다음과 같이 k번째 error vector를 정의하자.
![Ch8 Classical Iterative Method - part1](./images/img-021.png)
여기서 x는 밑의 우리가 풀고자하는 식을 만족하는 True해 이고.
![Ch8 Classical Iterative Method - part1](./images/img-022.png)
x k 는 밑의 우리가 정의한 iterative equation을 만족하는 k번째 updated solution, xk이다.
![Ch8 Classical Iterative Method - part1](./images/img-023.png)
e(k+1) - e(k)를 진행하면, 재밌는 사실은 다음의 G = M-1N matrx을 계속 곱해주는 관계식이 도출된다.
![Ch8 Classical Iterative Method - part1](./images/img-024.png)
등비수열 꼴이므로, 초기 e(0)에 G를 k번 곱한 것이 바로 e(k)
![Ch8 Classical Iterative Method - part1](./images/img-025.png)
여기서 G = M-1N이 n개의 독립적인 eigen vectors and values가 있다고 가정을 하면,
![Ch8 Classical Iterative Method - part1](./images/img-026.png)
e(0)의 차원은 n x 1 이므로 위, n개의 기저벡터로 표현가능하다.
![Ch8 Classical Iterative Method - part1](./images/img-027.png)
Eigen vector, value성질을 이용하면
Gv1 = λ1v1 이므로,
![Ch8 Classical Iterative Method - part1](./images/img-028.png)
우리의 목표는 e(k) -> 0 이므로,
위 e(k) 식은 가장 큰 abs(eigen value) < 1이면 달성 가능하다는 사실을 의미한다.
![Ch8 Classical Iterative Method - part1](./images/img-029.png)

...
Source: [https://jeffdissel.tistory.com/m/230](https://jeffdissel.tistory.com/m/230)
...
![5. Singular Value decomposition(SVD) - part2](./images/img-001.png)
핵심은 조건에 상관없이
"모든 모든 모든"
...
도 가능하다.
![5. Singular Value decomposition(SVD) - part2](./images/img-002.png)
...
나머지는 여러개가 존재할 수 있다.
![5. Singular Value decomposition(SVD) - part2](./images/img-003.png)
그렇다면, 어떻게 도대체 저렇게 모든 A에 대해
분해가 가능한거지??? How come
그 이유는 SVD가 어떤 작업인지를 이해하면 자동으로 납득이 된다.
Matrix A
를 다음과 같이 정의하자.
![5. Singular Value decomposition(SVD) - part2](./images/img-004.png)
저 위에 정의된 A의 숫자들은 열벡터들로 구성이 되어 있고,
우리가 익숙한
표준 기저들 (e1,e2,e3)를 기준
으로
expand되어있는 정도를 나타낸다.
![5. Singular Value decomposition(SVD) - part2](./images/img-005.jpg)
...
![5. Singular Value decomposition(SVD) - part2](./images/img-006.jpg)
즉, x를 다른 방식으로 변환하였고,
A가 어떤 값이든지, 같은 변환을 sigma, V, U로 가능하다는 것이다.
![5. Singular Value decomposition(SVD) - part2](./images/img-007.jpg)
for all A
U는 Orthogonal Matrix이므로 넘겨주면,
![5. Singular Value decomposition(SVD) - part2](./images/img-008.png)
자 다시. 1,2 과정을 살펴보자.
![5. Singular Value decomposition(SVD) - part2](./images/img-006.jpg)
U*(Ax)가 의미하는 것은,
...
이를 정리해보면 다음과 같다.
![5. Singular Value decomposition(SVD) - part2](./images/img-009.jpg)
x1' 은 x벡터에서 v1방향을 나타내는 값.
애매모호한 개념이지만 우리가 이미. 사용하고 있었다.
![5. Singular Value decomposition(SVD) - part2](./images/img-010.png)
x1 은 e1방향으로의 값,
x2는 e2방향으로의 값
...
![5. Singular Value decomposition(SVD) - part2](./images/img-011.png)
SVD와 차이점은, 1개의 bases로 표현한다는 것
A : n x n square Matrix이어야만 한다는 것.
![5. Singular Value decomposition(SVD) - part2](./images/img-012.png)
===========================================================================
놀랍게도 지금까지 복습이었고,
...
![5. Singular Value decomposition(SVD) - part2](./images/img-013.png)
...
(분해성공)
자세한 과정은 다음과 같다.
![5. Singular Value decomposition(SVD) - part2](./images/img-014.png)
바로 예시로 들어가보자.
![5. Singular Value decomposition(SVD) - part2](./images/img-015.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-016.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-017.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-016.png)
...
![5. Singular Value decomposition(SVD) - part2](./images/img-018.png)
V는 AA*의 Eigen vector이 열벡터로 이루어진 Matrix이므로,
![5. Singular Value decomposition(SVD) - part2](./images/img-019.png)
eigen vectors of AA* = U
이제 마지막으로 V만 구하면 SVD성공이다.
간단하게 SVD의 정의를 활용하면
![5. Singular Value decomposition(SVD) - part2](./images/img-020.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-021.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-022.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-020.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-021.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-022.png)
한편, H = A*A의 eigen value = singular value of A ^2이므로 다음과 같다.
![5. Singular Value decomposition(SVD) - part2](./images/img-023.png)
위 식의 좌항에 대입해주면, v를 sigma, A, u로 표현가능하다.
![5. Singular Value decomposition(SVD) - part2](./images/img-024.png)
따라서,
![5. Singular Value decomposition(SVD) - part2](./images/img-025.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-026.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-025.png)
![5. Singular Value decomposition(SVD) - part2](./images/img-026.png)
...
![5. Singular Value decomposition(SVD) - part2](./images/img-027.png)
한편 A를 SVD해주면, 다음의 관계식을 얻을 수 있다.
![5. Singular Value decomposition(SVD) - part2](./images/img-028.png)
이후 H를 EigenValue Decomposition form으로 변환할 수 있다.
![5. Singular Value decomposition(SVD) - part2](./images/img-029.png)
...
![5. Singular Value decomposition(SVD) - part2](./images/img-030.png)
...
![5. Singular Value decomposition(SVD) - part2](./images/img-031.png)
여기서 이제 마지막으로
Method1
을 사용해주어,
B -> Σ

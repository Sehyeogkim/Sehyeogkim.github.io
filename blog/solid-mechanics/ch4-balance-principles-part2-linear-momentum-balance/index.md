...
Source: [https://jeffdissel.tistory.com/177](https://jeffdissel.tistory.com/177)

Continuum Body에 작용하는,
Linear momentum balance 식을 이번에는 전개해보자.
#4.3 Linear momentum Balance.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-001.jpg)
...
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-002.png)
여기서 우항의 경우,
scalar function per unit mass
reynolds transport theorem 식을 통해서 derivative를 안으로 짚어 넣을 수 있다.
(지난시간에 증명완료)
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-003.png)
이후에 t = Tn 즉 Cauchy stress tensor (T)를 대입해주자.
그리고 divergence Theorem을 이용하면, 우리는 다음의 Cauchy's 1st eq of motion을
유도할 수 있다.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-004.png)
위 식은 전체 domain에 대해서 적분한 값이고,
이 값을 locally즉 미소 단위의 volume, surface에 적용시킨 식,
locally we can say.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-005.png)
...
r = x - o
(r,x,0 전부 벡터)
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-006.png)
13번식의 좌항의 경우 계속해서 쓰인다는 지난시간 11번 Reynolds Transport Therorem식에 의해서
다음과 같이 표현할 수 있다.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-007.png)
여기서, 우항 첫번째항을 살펴보자.
외적항의 미분을 전개하면, 평행한 부분이 나오므로
한개의 항으로 줄어든다.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-008.png)
이후에, 식을 쭉 전개하면 continutiy eq 8번식!!!
으로 소거항이 생긴다.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-009.png)
...
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-010.png)
...
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-011.png)
...
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-012.png)
...
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-013.png)
...
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-014.png)
즉 위 13번 식에서 1번항을 정리하였다.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-015.png)
이후에, 우항을 전부 좌항으로 넘기고 r 외적으로 묶어주자.
묶으면 Cauchy's 1st eq of Motion이 나오게 되므로 15번 식이 유도된다.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-016.png)
15번식이 의미하는게 무엇일까?
이해하기 위해서 index notation으로 다시 전환해보자.
![Ch4 Balance principles - part2 (Linear momentum balance)](./images/img-017.jpg)

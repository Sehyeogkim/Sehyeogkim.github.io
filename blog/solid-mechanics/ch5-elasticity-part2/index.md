...
![CH5 Elasticity - part2](./images/img-003.png)
여기서 이제, Uniaxial 인 경우, (한방향으로만 stress가 존재하는 경우)
위 tensor식을 전개하면
![CH5 Elasticity - part2](./images/img-004.png)
여기서 우리는 Young's Modulus, Poison's Ratio를 다음과 같이 정의한다.
![CH5 Elasticity - part2](./images/img-005.png)
(uniaxial 상황에서 유도함)

...
Source: [https://jeffdissel.tistory.com/m/179](https://jeffdissel.tistory.com/m/179)
...
![Ch2 Mathematical description of Physical Phenomena](./images/img-001.png)
infinitismal unit volume
![Ch2 Mathematical description of Physical Phenomena](./images/img-002.png)
일반적으로 식을 세웠던 방식. 결국, Reynodls transport Theroem
아마 무조건 배웠던 식들을 다시한번 써보자.
![Ch2 Mathematical description of Physical Phenomena](./images/img-003.png)
continuity eq - mass conservation
![Ch2 Mathematical description of Physical Phenomena](./images/img-004.png)
x방향 linear momentum balance eq.
![Ch2 Mathematical description of Physical Phenomena](./images/img-005.png)
steady state, ideal gas, c(constant specific heat coefficient) assumption Energy balance equation.
![Ch2 Mathematical description of Physical Phenomena](./images/img-006.png)
Conservation of Chemical Species.
위 식들은 결국 tranport Eq. conservation Eq이기 때문에
종합적으로 밑의 형태로 일반화 시킬 수 있다.
![Ch2 Mathematical description of Physical Phenomena](./images/img-007.png)
우리가 구하고 싶은 함수는 x,y,z,t 시공간에 따른 스칼라 함수 혹은 벡터함수.
![Ch2 Mathematical description of Physical Phenomena](./images/img-008.png)
여기서 한발짝 더 나아가서,
여기서 일반화 시킨
partial differentia eq
의 종류를 구분 지을 필요가 있다.
종류를 나누어보고, 왜 구분 짓는지 그 본질을 이해해보자.
![Ch2 Mathematical description of Physical Phenomena](./images/img-009.png)
이렇게 쉽게 생각해보자.
...
![Ch2 Mathematical description of Physical Phenomena](./images/img-010.png)
여기서 우리는 풀어야하는 방정식의 해가 공간 안에서 one way, two way인지에 따라서
방정식의 종류를 구분짓는다.
parabolic -> one way,
elliptic -> two way이다.
![Ch2 Mathematical description of Physical Phenomena](./images/img-011.png)
이와 별개로 잡종으로
hyperbolic
이라는 종류도 존재한다.
one way behavior 즉,
...
![Ch2 Mathematical description of Physical Phenomena](./images/img-012.png)
...
(d^2 u/dx^2 ~ 0)
![Ch2 Mathematical description of Physical Phenomena](./images/img-013.png)
x방향으로만 해가 전파되므로 parabolic.
말로 정의를 하는 것보다 직접 함수식을 보면서,
어떤게 parabolic, elliptic 그리고 hyperbolic인지를 살펴보자.
![Ch2 Mathematical description of Physical Phenomena](./images/img-014.png)
2nd order PDE
![Ch2 Mathematical description of Physical Phenomena](./images/img-015.png)
구분 짓는 수학적 기준.
1. Parabolic - 1D transient heat conductance.
![Ch2 Mathematical description of Physical Phenomena](./images/img-016.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-017.png)
inital conditon and boundary conditons
위 식의 b^2-4ac < 0 임을 쉽게 알 수 있고,
해가 시간이 증가하는 방향으로 전파된다.
따라서 parabolic.
![Ch2 Mathematical description of Physical Phenomena](./images/img-018.png)
시간에 따라 해가 변하며, 미래의 해가 현재에 영향을 주지 않는다
2. Ellitpic - Laplace Equation
![Ch2 Mathematical description of Physical Phenomena](./images/img-019.png)
2D steady heat conduction, b^2 - 4ac = 0
4방향으로 온도를 고정하는 boundary condition을 부여하자.
![Ch2 Mathematical description of Physical Phenomena](./images/img-020.png)
저 사각형 안에 있는 영역의 해는
x,-x, y, -y모든 방향에 있는 boundary conditoin으로 부터
영향을 받는다.
-> two way , ellipitic
3. Hyperbolic - Transient Wave equation.
![Ch2 Mathematical description of Physical Phenomena](./images/img-021.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-022.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-023.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-021.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-022.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-023.png)
...
![Ch2 Mathematical description of Physical Phenomena](./images/img-024.png)
(즉 저 선 밖에 있는 영역으로는 해가 전파되지 않는 것)
해가 전파되는 영역을
'Zone of Influence' 라고 부른다.
각 종류별 2개의 예시들.
![Ch2 Mathematical description of Physical Phenomena](./images/img-025.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-026.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-027.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-025.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-026.png)
![Ch2 Mathematical description of Physical Phenomena](./images/img-027.png)
마지막으로 각 종류별로 Zone of influence(domain of influence)를 보고, 개념을 정리하자.
Domain of influence안에 있는 해가 바로 P(x,t) 현재 해에 영향을 준것이다.
![Ch2 Mathematical description of Physical Phenomena](./images/img-028.png)

---
title: "Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)"
layout: knowledge-home
source_url: "https://jeffdissel.tistory.com/m/197"
source_id: "197"
date: "2025-05-03T11:27:45+09:00"
category: "Numerical-Heat-transfer-and-Fluid-flow"
---

Source: [https://jeffdissel.tistory.com/m/197](https://jeffdissel.tistory.com/m/197)
...
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-001.png)
1D Steady Convection Diffusion Equation
여기서 새로운 개념을 정의하자, Total flux는 Convection Flux, Diffusion flux로 구성.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-002.png)
자세히 살펴보면 6번식을 dx로 미분하면 1번식이 된다. 따라서, e,w에서 Total flux가 같다는 8번식이 도출된다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-003.png)
표기상 7번 식 = 1번식 입니다. 우리가 풀려고 하는 differential Eq.
6번식 J를 이제 x = e,w에서 구하기 위해서 part2에서 구했던 1번식의
exact solution을 이용하자.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-004.png)
exact solution of Eq1.
J를 구하기 위해서는 6번식에 d
Φ
/dx 가 존재하므로 x에 대해 미분해주자.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-005.png)
구한 Φ, d
Φ/dx를 6번 total flux식에 대입해주면 다음과 같다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-006.png)
여기서 이제 우리는 o,L을 우리의 control volume에 맞게 설정해주면
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-007.png)
O -> P, L ->E로 설정하면 Je식이 도출.
9번식이 도출된다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-008.png)
같은 방식으로 마지막에
O -> W, L ->P로 설정하면 J_w식이 도출.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-009.png)
이를 이제 Algebriac form으로 바꾸어 주면 계수들이 다음과 같다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-010.png)
...
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-011.png)
exact solution based coefficient a_E
ae/De를 Pecelt number에 다른 함수로 그려보면 아래와 같다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-012.png)
즉 위의 그래프가 바로 exact solution이지만, 계산연산이 많으므로
3구간으로 나눈후 linear function을 각 구간에 대해 정의한 것이 바로.
hybrid shceme.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-013.png)
특징 바로 - inf, + inf일때 위. 함수가 결국 좌우구간으로 설정한 직선함수로 수렴한다는 것이다.
그리고 그 두 직선함수를 잇기 위해서 Pe = 0 에서 접하는 직선으로 이어준 것.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-014.png)
구간으로 나누어 정의한 a_E를 이제 하나의 기호로 표현하면 다음과 같다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-015.png)
같은 방식을 a_W로 똑같이 진행해보면, 우리가 최종적으로 유도하는 algebriac eq은 다음과 같다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-016.png)
...
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-017.png)
정확한 구간별 a_E/De 를 Peclet number로 나눈 구간함수는 다음과 같다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-018.png)
수학의 마술로, 한줄로 위. 4 구간함수를 표현가능하다.
![Ch5 Convection and Diffusion - part3 (Expotential, hybrid scheme)](./images/img-019.png)
지금까지 살펴본 내용을 정리해보면,

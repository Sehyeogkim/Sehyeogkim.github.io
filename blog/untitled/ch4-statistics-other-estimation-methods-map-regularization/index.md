...
sidebar:
  nav: "docs"
source_url: "https://jeffdissel.tistory.com/m/238"
source_id: "238"
date: "2025-09-14T14:35:41+09:00"
category: "과학"
---

Source: [https://jeffdissel.tistory.com/m/238](https://jeffdissel.tistory.com/m/238)
...
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-001.png)
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-002.png)
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-001.png)
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-002.png)
2. Recursive Estimation.
이번에는 실시간으로 데이터가 계속 추가되는 상황을 생각해보자.
(시간 = index라 생각하자 1초마다 새로운 데이터 추가)
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-003.png)
Set of Data, y1, y2 ... yt.
시간 (t-1)까지, 누적된 데이터 집합, D1:(t-1)
D1:(t-1)까지 데이터를 가지고 예측한 파라메터를 다음과 같이 정의하자.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-004.png)
그랬을때, 우리가 Gaussian Distribution을 사용한다고 가정하면,
t일때는 데이터 yt가 기존데이터(
D1:(t-1)
에서 추가 되는 것을 알 수 있다.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-005.png)
Gaussian mean
이때, 기존 데이터를 모두 읽을 필요가 없이, 기존에 예측하던 mean u(t-1)을 가지고 업데이트를 할 수 있다.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-006.png)
...
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-007.png)
Recursive function 이기 때문에, 등비수열꼴이므로 전개를 해주면,
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-008.png)
즉, 맨 마지막의 데이터가 가장 현재 mean에 영향을 많이 주고,
시간이 지날수록 과거 데이터의 영향이 줄어드는 것을 알 수 있다.
그래프로 이해해보자.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-009.png)
...
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-010.png)
...
θ를 찾고, MLE라고 정의하자.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-011.png)
하지만, 이렇게 하다보면 주어진 데이터에만 잘 맞는 overfitting 문제가 발생할 수 있다.
이를 해결하기 위한 솔루션이 바로
Regularization
논리는 penalty Term 을 Log-Likelihood function에 추가해주는 것.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-012.png)
λ: Regularization Parameter
C(θ) : Complexity Penalty.
(페널티라는 단어를 꼭 기억하자)
예를들어서, C(
θ) = log [ p( θ) ] 라고 가정하자.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-013.png)
λ = 1/N으로 설정하면 log liklihood를 다음과 같이 바꾸어 표현가능하다.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-014.png)
즉, bayes rule을 통해서 p(θ|D) Posterior probability를 극대화하는 문제로 전환됨을 알 수 있다.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-015.png)
in other words, Maximum a posterior estimation (MAP)문제
= MLE +Penalty(Prior)
MLE에 패널티가 추가된 것,
그리고 그 패널티가 바로 Prior
prior이외에 다른 penalty 부과 방식은 weight Decay
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-016.png)
...
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-017.png)
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-016.png)
...
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-018.png)
그리고 미분을 통해서 stagnation point를
theata
를 찾자.
(위 R을 가장 작게하는 theata 찾기)
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-019.png)
이제, 방금 구한
theat를 사용하고, D_valid 를 가지고
Regularized Empirical Risk (MAP at given D_valid) 를 구하자.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-020.png)
=================================================================================
우리가 해야할 것은,
위 Block을 계속해서 반복하면서, 최적의 lambda를 찾는 것
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-021.png)
그리고, 그떄 최적의 lambda를 구하면 그것을 기준으로의 theat를 구하면 완성된다.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-022.png)
2. Cross Validation
...
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-023.png)
즉 우리는 위 5개에 대해서,
(방금 전에 배운 Validation Set)
과정을 진행해 주어서, 총 5개의
Regularized Empirical Risk을구한다.
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-024.png)
...
![Ch4 Statistics - Other Estimation Methods - MAP, Regularization](./images/img-025.png)

---
title: "Finite element Method Ch1 strong and weak form."
layout: single
author_profile: false
sidebar:
  nav: "docs"
source_url: "https://jeffdissel.tistory.com/m/215"
source_id: "215"
date: "2025-06-22T10:02:37+09:00"
category: "Finite-Element-Method"
---

Source: [https://jeffdissel.tistory.com/m/215](https://jeffdissel.tistory.com/m/215)
...
![Finite element Method Ch1 strong and weak form.](./images/img-001.png)
위 PDE에 주어진 Boundary value를 만족하는 u를 찾는게 우리의 목표다.
![Finite element Method Ch1 strong and weak form.](./images/img-002.png)
위 목표를 수학적 명제로 표현하게 되면 아래와 같고, 편의상 우리는 이 명제를 Strong form이라고 칭하자.
![Finite element Method Ch1 strong and weak form.](./images/img-003.png)
...
![Finite element Method Ch1 strong and weak form.](./images/img-004.png)
위 적분기호들이 굉장히 많이 나오기 때문에, 편의상 밑 기호들로 치환해주자.
![Finite element Method Ch1 strong and weak form.](./images/img-005.png)
따라서, 최종적으로 치환된 Weak form Eq은 다음과 같다.
![Finite element Method Ch1 strong and weak form.](./images/img-006.png)
...
![Finite element Method Ch1 strong and weak form.](./images/img-007.png)
두가지 의문이 들것이다.
Q1. w(1) = 0 ? why?
...
![Finite element Method Ch1 strong and weak form.](./images/img-008.png)
어떠한 함수의 제곱의 적분이 bounded 즉 유한한 함수를 square intergable 이라고 표현하고,
기호로는 L2함수라고 표기한다.
그리고 만약에 미분함수들이 square integrable한 경우는 다르게 표기를 하는데 여기서
등장하는 함수가 H0 , H1 ...함수이다.
![Finite element Method Ch1 strong and weak form.](./images/img-009.png)
쉽게 눈치를 채셨겠지만, n번 미분함 함수가 square intergable하다면, 우리는 그 함수를 Hn function이라고 칭한다.
![Finite element Method Ch1 strong and weak form.](./images/img-010.png)
여기서 마지막으로 한단계만 더 나아가면, 어떠한 함수와 그 함수의 k번 미분한 함수까지 전부다 square integrable하다면,
우리는 그 함수가 Soblev Spaces(H^K)안에 있다고 정의한다.
![Finite element Method Ch1 strong and weak form.](./images/img-011.png)
다시 위 개념들을 장착한 상태에서 weak form의 정의를 다시 살펴보자.
![Finite element Method Ch1 strong and weak form.](./images/img-012.png)
여기서 w함수는 H1함수 이어야 하고, 다시말해 w(x), dw/dx 함수 두가지 모두 square integrable하다는 말이다.
![Finite element Method Ch1 strong and weak form.](./images/img-013.png)
자 이제 마지막으로, strong form 과 weak form이 두개가 동치임을 증명하자.
먼저, (S)의 해이면, (W)의 해임을 증명하면 다음과 같다,
![Finite element Method Ch1 strong and weak form.](./images/img-014.png)
반대로, (W)의 해이면, (S)의 해임을 보이면 다음과 같다.
![Finite element Method Ch1 strong and weak form.](./images/img-015.png)

...
Source: [https://jeffdissel.tistory.com/8](https://jeffdissel.tistory.com/8)
...
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-001.png)
...
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-002.png)
...
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-003.png)
2. Momentum Equation
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-004.png)
Continuity 식에서 dV를 Momentum 식에서 dV에 대입해보자
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-005.png)
여기서 끝난게 아니라 한발 남았다.
...
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-006.png)
#Isentropic process에서 Energy equation
Tds = 0 =dh- vdp = du + pdv를 통해서 다음과 같이 식을 유도할 수 있다.(
ch1 이전 포스트에서 증명완료
)
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-007.png)
여기에 Ideal gas Assumption 까지 가정해주면 (p =
ρ
RT)
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-008.png)
따라서 이상기체의 경우,
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-009.png)
이제 파동 근원의 속도에 따라서
파동이 어떻게 전파되는지 살펴보자
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-010.png)
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-011.png)
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-012.png)
...
![[Gas Dynamics] Ch 4 Introduction to Compressible Flow - part1](./images/img-013.png)
